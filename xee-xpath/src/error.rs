...
pub enum Error {
    ...
    #[strum(message = "Component absent in static context")]
    XPST0001,
    ...
    #[strum(message = "Component absent in dynamic context")]
    XPDY0002,
    /// Parse error.
    ///
    ...
    /// is `empty-sequence()`.
    #[strum(message = "Empty sequence type error")]
    XPST0005,
    /// Name not defined.
    ///
    ...
    #[strum(message = "Name not defined")]
    XPST0008,
    ...
    #[strum(message = "Namespace axis not supported")]
    XPST0010,
    ...
    #[strum(message = "Type error: incorrect function name or number of arguments")]
    XPST0017,
    /// Type error: inconsistent sequence.
    ///
    /// It is a type error if the result of a path operator contains both nodes
    /// and non-nodes.
    #[strum(message = "Type error: inconsistent sequence")]
    XPTY0018,
    ...
    /// sequence of nodes.
    #[strum(message = "Type error: path operator must be applied to node sequence")]
    XPTY0019,
    ...
    #[strum(message = "Type error: context item is not a node in an axis step.")]
    XPTY0020,
    ...
    #[strum(message = "Multiple parameters with same name")]
    XQST0039,
    ...
    /// nor a relative URI.
    #[strum(message = "Invalid Braced URI Literal")]
    XQST0046,
    ...
    #[strum(message = "Treat type does not match sequence type")]
    XPDY0050,
    ...
    #[strum(message = "Invalid type named in cast or castable expression")]
    XQST0052,
    /// Illegal prefix
    ///
    ...
    #[strum(message = "Invalid target type of cast or castable expression")]
    XPST0080,
    ...
    #[strum(message = "Unknown namespace prefix")]
    XPST0081,
    ...
    /// error is raised.
    #[strum(message = "Type error: namespace-sensitive type expected")]
    XPTY0117,
    /// Implementation-dependent limit exceeded.
    ///
    /// An implementation-dependent limit has been exceeded.
    #[strum(message = "Implementation-dependent limit exceeded")]
    XPDY0130,
    /// Namespace axis not supported.
    ///
    ...
    #[strum(message = "Duplicate key values in a map")]
    XQDY0137,
    ...
    #[strum(message = "Numeric operation overflow/underflow")]
    FOAR0002,
    ...
    #[strum(message = "Input value too large for decimal")]
    FOCA0001,
    ...
    #[strum(message = "Invalid lexical value")]
    FOCA0002,
    ...
    #[strum(message = "Input too large for integer")]
    FOCA0003,
    ...
    #[strum(message = "NaN supplied as float/double value")]
    FOCA0005,
    ...
    #[strum(message = "Collation does not support collation units")]
    FOCH0004,
    /// No context document.
    ///
    ...
    /// not a document node.
    #[strum(message = "No context document")]
    FODC0001,
    ...
    #[strum(message = "Invalid argument to fn:doc or fn:doc-available")]
    FODC0005,
    ...
    #[strum(message = "String passed to fn:parse-xml is not a well-formed XML document")]
    FODC0006,
    ...
    /// optional feature.
    #[strum(message = "The processor does not support serialization")]
    FODC0010,
    ...
    /// a matching name.
    #[strum(message = "Invalid decimal format name")]
    FODF1280,
    ...
    #[strum(message = "Invalid decimal format picture string")]
    FODF1310,
    ...
    #[strum(message = "Overflow/underflow in date/time operation")]
    FODT0001,
    ...
    /// syntax.
    #[strum(message = "Invalid date/time formatting parameters")]
    FOFD1340,
    ...
    /// present in a time.
    #[strum(message = "Invalid date/time formatting component")]
    FOFD1350,
    /// JSON syntax error.
    ///
    ...
    #[strum(message = "JSON syntax error")]
    FOJS0001,
    /// JSON duplicate keys.
    ///
    ...
    #[strum(message = "JSON duplicate keys")]
    FOJS0003,
    ...
    #[strum(message = "Invalid XML representation of JSON")]
    FOJS0006,
    ...
    #[strum(message = "Bad JSON escape sequence")]
    FOJS0007,
    ...
    /// library module.
    #[strum(message = "Static error in dynamically-loaded XQuery module")]
    FOQM0003,
    ...
    #[strum(message = "Parameter for dynamically-loaded XQuery module has incorrect type")]
    FOQM0005,
    ...
    /// all).
    #[strum(message = "No suitable XQuery processor available")]
    FOQM0006,
    ...
    #[strum(message = "fn:zero-or-one called with a sequence containing more than one item")]
    FORG0003,
    ...
    #[strum(message = "fn:one-or-more called with a sequence containing no items")]
    FORG0004,
    ...
    #[strum(
        message = "fn:exactly-one called with a sequence containing zero or more than one item"
    )]
    FORG0005,
    ...
    #[strum(message = "Invalid argument type")]
    FORG0006,
    ...
    #[strum(message = "The two arguments to fn:dateTime have inconsistent timezones")]
    FORG0008,
    ...
    #[strum(message = "Error in resolving a relative URI against a base URI in fn:resolve-uri")]
    FORG0009,
    /// Invalid date/time.
    ///
    ...
    /// 31 February.
    #[strum(message = "Invalid date/time")]
    FORG0010,
    ...
    /// than i, m, q, s, or x.
    #[strum(message = "Invalid regular expression flags")]
    FORX0001,
    /// Invalid regular expression.
    ///
    /// Raised by regular expression functions such as fn:matches and
    /// fn:replace if the regular expression is syntactically invalid.
    #[strum(message = "Invalid regular expression")]
    FORX0002,
    ...
    /// string.
    #[strum(message = "Regular expression matches zero-length string")]
    FORX0003,
    /// Invalid replacement string.
    ///
    /// Raised by fn:replace to report errors in the replacement string.
    #[strum(message = "Invalid replacement string")]
    FORX0004,
    ...
    #[strum(message = "Argument to fn:data() contains a node without a typed value")]
    FOTY0012,
    ...
    #[strum(message = "Argument to fn:data() contains a function item")]
    FOTY0013,
    ...
    #[strum(message = "Argument to fn:string() is a function item")]
    FOTY0014,
    ...
    /// item.
    #[strum(message = "Argument to fn:deep-equal() contains a function item")]
    FOTY0015,
    ...
    /// text.
    #[strum(message = "Invalid $href argument to fn:unparsed-text()")]
    FOUT1170,
    ...
    #[strum(message = "Cannot decode resource retrieved by fn:unparsed-text()")]
    FOUT1190,
    ...
    /// is not UTF-8.
    #[strum(message = "Cannot infer encoding of resource retrieved by fn:unparsed-text()")]
    FOUT1200,
    ...
    #[strum(message = "No suitable XSLT processor available")]
    FOXT0001,
    ...
    #[strum(message = "Invalid parameters to XSLT transformation")]
    FOXT0002,
    ...
    /// 1.0 processor.
    #[strum(message = "XSLT transformation failed")]
    FOXT0003,
    ...
    #[strum(message = "XSLT transformation has been disabled")]
    FOXT0004,
    ...
    #[strum(message = "XSLT output contains non-accepted characters")]
    FOXT0006,

    #[strum(message = "Unsupported XPath feature")]
    Unsupported,
}
