...
impl Xs {
    ...
    pub fn rust_info(&self) -> Option<RustInfo> {
        ...
        match self {
            ...
            YearMonthDuration => Some(RustInfo::new("crate::YearMonthDuration")),
            DayTimeDuration => Some(RustInfo::new("chrono::Duration")),
            DateTime => Some(RustInfo::new("crate::NaiveDateTimeWithOffset")),
            DateTimeStamp => Some(RustInfo::new("chrono::DateTime<chrono::FixedOffset>>")),
            Time => Some(RustInfo::new("crate::NaiveTimeWithOffset")),
            Date => Some(RustInfo::new("crate::NaiveDateWithOffset")),
            GYearMonth => Some(RustInfo::new("crate::GYearMonth")),
            GYear => Some(RustInfo::new("crate::GYear")),
            GMonthDay => Some(RustInfo::new("crate::GMonthDay")),
            GDay => Some(RustInfo::new("crate::GDay")),
            GMonth => Some(RustInfo::new("crate::GMonth")),
